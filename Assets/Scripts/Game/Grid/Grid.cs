...
public class Grid : MonoBehaviour
{
    ...
    private void CheckIfShapeCanBePlaced()
    {
        ...
        var currentSelcetedShape = shapeStorage.GetCurrentSelectedShape();
        if (currentSelcetedShape == null)
        {
            return;
        }

        if (currentSelcetedShape.TotalSquareNumber == squareIndexes.Count)
        {
            ...
            {
                GameEvent.SetShapeInative();
            }
            CheckIfAnyCompletedLine();
        }
        else
        {
            GameEvent.MoveShapeToStartPotition();
        }
    }
    ...
    private bool CheckIfShapeCanBePlacedOnGrid(Shape currentShape)
    {
        ...
        {
            Debug.LogError("ko khop voi khoi");
        }
